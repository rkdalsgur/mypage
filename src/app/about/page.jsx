  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div>
          <h2 className="text-center text-2xl">자기 소개</h2>
          <br />
          <br />
          <h2 className="text-center text-xl">생년월일: 2001.02.20</h2>
          <br />
          <h2 className="text-center text-xl">학번: 92014942</h2> <br />
          <h2 className="text-center text-xl">전공: 정보보호학과</h2>
          <br />
          <h2 className="text-center text-xl">연락처: 010-5772-0285</h2>
        </div>
        <br />
        <br />
        <br />
